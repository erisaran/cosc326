...
class Arithemetic {
  ...
  /** creates a combination of + and * a pads it with the right amount of operators
    * @param i int representing the iteration of operators to create
    * @param n the amount of operators needed
    * @return String a binary number representing a sequence of operators.
    */
  private static String comb(int i, int n){
    String c = Integer.toBinaryString(i); String s = "";
    for (int q = 0; q < n -1; q++) s += 0;
